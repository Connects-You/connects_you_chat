import {
	RemoveEmotionForMessageRequest,
	RemoveEmotionForMessageResponse,
	ResponseStatusEnum,
...
export const removeEmotionForMessage = async (
	req: ServerUnaryCall<RemoveEmotionForMessageRequest, RemoveEmotionForMessageResponse>,
	callback: sendUnaryData<RemoveEmotionForMessageResponse>,
) => {
	try {
		const { emotionId, messageId } = req.request;
